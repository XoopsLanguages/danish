...
define('_OXYGEN_USERSETTINGS', 'Indstillinger for brugerinfo');
define('_OXYGEN_METAFOOTER', 'Meta Tags and Footer');
define('_OXYGEN_CENSOR', 'Indstillinger for ordcensurering');
define('_OXYGEN_SEARCH', 'Søgemuligheder');
define('_OXYGEN_MAILER', 'E-mail-opsætning');

...
define($constpref."_DESC","Dette modul beskytter dit XOOPS-sted mod forskellige angreb som DoS, SQL Injection og Variables kontaminering.");
// Menu
...
define($constpref."_ADMINHOME","Hjem");
define($constpref."_ADMINABOUT","Om");
//3.50
define($constpref.'_STOPFORUMSPAM_ACTION','Stop Forum Spam');
define($constpref.'_STOPFORUMSPAM_ACTIONDSC','Checks POST data for spammers registeret på www.stopforumspam.com database. Php CURL lib. nødvendigt');
// 3.60
define($constpref . '_ADMINSTATS', 'Overblik');
define($constpref . '_BANIP_TIME0DSC', 'Suspensionstid i sekunder for automatiske IP-forbud');
}
$constpref = '_MI_' . strtoupper( $mydirname);
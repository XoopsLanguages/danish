...
define('_SELECTFILES', 'Vælg filer');
define('_DROPFILESHERE', 'Drop filer her');
define('_RETRY', 'Prøv igen');
define('_OK', 'Ok');
define('_FORMATPROGRESS', '{percent}% af {total_size}');
define('_FAILUPLOAD', 'Opload fejlede');
define('_WAITINGFORRESPONSE', 'Arbejder...');
define('_PAUSED', 'På pause');
define('_PROCESSINGDROPPEDFILES', 'Gennemarbejder droppede filer');
define('_TYPEERROR', '{file} har en forkert filtype. Gyldige filtyper er : {extensions}!');
define('_SIZEERROR', '{file} er for stor, den maksimale filstørrelse er {sizeLimit}!');
define('_MINSIZEERROR', '{file} er for lille, er den minimale filstørrelse er {minSizeLimit}!');
define('_EMPTYERROR', '{file} er tom, du må vælge filer igen men foruden den!');
define('_NOFILESERROR', 'Ingen filer at oploade!');
define('_TOOMANYITEMSERROR', 'For mange varer ({netItems}) vil blive uploadet. Varegrænse er {itemLimit}!');
define('_MAXHEIGHTIMAGEERROR', 'Billede er for højt!!');
define('_MAXWIDTHIMAGEERROR', 'Billede er for bredt!');
define('_MINHEIGHTIMAGEERROR', 'Billedet er ikke højt nok!');
define('_MINWIDTHIMAGEERROR', 'Billedet er ikke bredt nok!');
define('_RETRYFAILTOOMANYITEMS', 'Forsøg mislykkedes igen - du har nået din filgrænse!');
define('_ONLEAVE', 'Filerne uploades, hvis du forlader det nu, afbrydes uploadet!');
define('_UNSUPPORTEDBROWSERIOS8SAFARI', 'Uoprettelig fejl - denne browser tillader ikke filupload af nogen art på grund af alvorlige fejl i iOS8 Safari. Brug venligst iOS8 Chrome, indtil Apple løser disse problemer!');
...
//define('_XOBJ_ERR_INVALID_EMAIL', 'Ugyldig email');
//define('_XOBJ_ERR_INVALID_ENUMERATION', 'Ugyldig enumeration');

//XOOPS 2.5.9
define('_AM_MODULEADMIN_MISSING','Error: ModuleAdmin klassen mangler. Du skal installere ModuleAdmin Class i /Frameworks (se / docs / readme.txt)');

...
define('_TZ_GMTM6', '(GMT-6: 00) Central Time (USA og Canada), Mexico City');
...
define('_TZ_GMTM1', '(GMT-1: 00) Azorerne, Kap Verde-øerne');
define('_TZ_GMT0', '(GMT) Greenwich Mean Time, London, Dublin, Lissabon, Casablanca, Monrovia');
define('_TZ_GMTP1', '(GMT +1:00) Amsterdam, Berlin, Rom, København, Bruxelles, Madrid, Paris');
define('_TZ_GMTP2', '(GMT +2:00) Athen, Istanbul, Minsk, Helsinki, Jerusalem, Sydafrika');
define('_TZ_GMTP3', '(GMT +3:00) Bagdad, Kuwait, Riyadh, Moskva, St. Petersborg');
...
define('_TZ_GMTP11', '(GMT +11:00) Magadan, Salomonøerne, Ny Kaledonien');

...
define('DB_HOST_HELP', 'Værtsnavn på databaseserver. Hvis du er usikker, <em> localhost </ em> virker i de fleste tilfælde'); // L67
...
define('DB_NAME_HELP', 'Navnet på databasen på værten. Installationsprogrammet vil forsøge at oprette den database, hvis den ikke eksisterer'); // L64
...
define('CHMOD_CHGRP_ERROR', 'Installeren kan muligvis ikke skrive til konfigfilen %1$s.<p>PHP skriver til filer under bruger %2$s og gruppe %3$s<p>Mappen %4$s/ er bruger %5$s og grupper %6$s');
//2.5.9
define("CURL_HTTP", "Klien URL lib (cURL)");
define('XOOPS_COOKIE_DOMAIN_LABEL', 'Cookie dom&aelig;ne for webside');
define('XOOPS_COOKIE_DOMAIN_HELP', 'Dom&aelig;ne for cookies. De kan være blanke, den fulde v&aelig;rt host fra URL (www.eksempel.com) eller det registrede dom&aelig;ne uden subs (eksempel.com) for at dele på tv&aelig;rs af subdom&aelig;ner (www.eksempel.com & blog.eksempel.com);');
define('INTL_SUPPORT', 'Internationaliserings funktioner');
define('XOOPS_SOURCE_CODE', "XOOPS på GitHub");
define('XOOPS_INSTALLING', 'Installerer');
define('XOOPS_ERROR_ENCOUNTERED', 'Fejl');
define('XOOPS_ERROR_SEE_BELOW', 'See herunder for beskeder.');
define('MODULES_AVAILABLE', 'Tilg&aelig;ængelige moduler');

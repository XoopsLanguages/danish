...
//XOOPS 2.5.8
define('_AM_PROTECTOR_PREFIX', 'Præfiks');
...
define('_AM_LABEL_BAN_BY_IP', 'Forbyd IP\'erne på kontrollerede poster:');
define('_AM_BUTTON_BAN_BY_IP', 'IP Forbud!');
define('_AM_JS_BANCONFIRM', 'IP Forbud OK?');
define('_AM_MSG_BANNEDIP', 'IP\'er er blokeret');
define('_AM_ADMINSTATS_TITLE', 'Protector log-oversigt');
// XOOPS 2.5.11
define('_AM_ADMINSTATS_LAST_MONTH', 'Sidste måned');
define('_AM_ADMINSTATS_LAST_WEEK', 'Sidste uge');
define('_AM_ADMINSTATS_LAST_DAY', 'Sidste dag');
define('_AM_ADMINSTATS_LAST_HOUR', 'Sidste time');

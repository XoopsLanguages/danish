...
define('XOOPS_DATA_PATH_LABEL', 'XOOPS datafilbibliotek');
...
define('XOOPS_URL_LABEL', 'Webstedets placering (URL)'); // L56
...
define('DB_HOST_LABEL', 'Serverhostnavn');    // L27
...
define('DB_PASS_LABEL', 'Adgangskode');    // L52
...
define('ERR_COPY_MAINFILE', 'Kunne ikke kopiere distributionsfilen til %s');
define('ERR_WRITE_MAINFILE', 'Kunne ikke skrive ind i %s. Tjek venligst filtilladelsen, og prøv igen.');
define('ERR_READ_MAINFILE', 'Kunne ikke åbne %s til læsning');
...
define('USER_LOGIN', 'Administratorlogin');
define('USERNAME', 'Brugernavn :');
define('PASSWORD', 'Password:');
define('ICONV_CONVERSION', 'Tegnsætkonvertering');
define('ZLIB_COMPRESSION', 'Zlib-komprimering');
define('IMAGE_FUNCTIONS', 'Billedfunktioner');
define('IMAGE_METAS', 'Billedmetadata (exif)');
...
//2.5.8
define('CHMOD_CHGRP_REPEAT', 'Prøv igen');
define('CHMOD_CHGRP_IGNORE', 'Brug alligevel');
define('CHMOD_CHGRP_ERROR', 'Installationsprogrammet er muligvis ikke i stand til at skrive konfigurationsfilen %1$s.<p>PHP skriver filer under bruger %2$s og gruppe %3$s.<p>Mappen %4$s/ har bruger %5$s og gruppe %6$s');
//2.5.9
define("CURL_HTTP", "Klient URL bibliotek (cURL)");
define('XOOPS_COOKIE_DOMAIN_LABEL', 'Cookie-domæne for webstedet');
define('XOOPS_COOKIE_DOMAIN_HELP', 'Domæne for at sætte cookies. Kan være tom, den fulde vært fra URL (www.example.com) eller det registrerede domæne uden underdomæner (example.com) til deling på tværs af underdomæner (www.example.com og blog.example.com.)');
...
define('XOOPS_ERROR_ENCOUNTERED', 'Fejl');
define('XOOPS_ERROR_SEE_BELOW', 'Se nedenfor for beskeder.');
define('MODULES_AVAILABLE', 'Tilgængelige moduler');
define('INSTALL_THIS_MODULE', 'Tilføj %s');
//2.5.11
define('ERR_COPY_CONFIG_FILE', 'Kunne ikke kopiere konfigurationsfilen %s');
//2.7.0
// website name and slogan
define('_WEBSITE_NAME', 'XOOPS websted');
define('_WEBSITE_SLOGAN', 'Bare brug det!');
define('_WEBSITE_META_KEYWORDS', 'xoops, webapplikationsramme, cms, indholdsstyringssystem');
define('_WEBSITE_FOOTER', "Drevet af XOOPS © 2001-{X_YEAR} <a href='https://xoops.org' rel='external' title='The XOOPS Project'>XOOPS-projektet</a>");
define('_WEBSITE_COPYRIGHT', 'Copyright © 2001-{X_YEAR}');
define('_WEBSITE_DESCRIPTION', 'XOOPS er et dynamisk objektorienteret baseret open source-portalscript skrevet i PHP.');
define('_WEBSITE_CENSOR_REPLACE', 'UPPS');

...
define('_PROFILE_AM_FLOAT', 'Flydende tal');
...
//XOOPS 2.5.11
define('_PROFILE_AM_EDIT_OPTION_STRINGS', 'Rediger valgstrenge');

// 2.7.4
define('_PROFILE_AM_DELETE_FAILED', 'Sletning af %s mislykkedes; kontoen blev ikke fjernet');

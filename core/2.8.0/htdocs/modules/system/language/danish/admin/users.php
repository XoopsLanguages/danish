...
define('_AM_SYSTEM_USERS_UID', 'Bruger-id');
define('_AM_SYSTEM_USERS_STATUS', 'Status:');
define('_AM_SYSTEM_USERS_NAME', 'Navn');
define('_AM_SYSTEM_USERS_UNAME', 'Kaldenavn');
...
define('_AM_SYSTEM_USERS_LOCATIONC', 'Placering indeholder');
define('_AM_SYSTEM_USERS_OCCUPATIONC', 'Position indeholder');
define('_AM_SYSTEM_USERS_INTERESTC', 'Interesse indeholder');
...
define('_AM_SYSTEM_USERS_SENDMAIL', 'Send en email');
...
define('_AM_SYSTEM_USERS_PWDEQUALSUNAME', 'Adgangskoden kan ikke være det samme som brugernavnet.');
...
define('_AM_SYSTEM_USERS_PSEUDO_ERROR', 'Brugernavn %s findes allerede');
define('_AM_SYSTEM_USERS_MAIL_ERROR', 'brugers email %s findes allerede');
define('_AM_SYSTEM_USERS_ACCEPT_EMAIL', 'Accepter email fra Admin');
define('_AM_SYSTEM_USERS_UNKNOWN_GROUP', 'Ukendt gruppe');

//2.7.1 backfilled translations
define('_AM_SYSTEM_USERS_CHANGEONLY', '(kun ved ændringer)');
define('_AM_SYSTEM_USERS_NO_FOUND', 'Ingen bruger(e) fundet');
define('_AM_SYSTEM_USERS_USERSFOUND', '%s bruger(e) fundet');

//2.7.4
define('_AM_SYSTEM_USERS_NO_SUCH_USER', 'Ingen sådan bruger');

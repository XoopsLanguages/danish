...
define('_AM_SYSTEM_BLOCKS_SIDETOPCENTER', 'Øverst i centrum');
...
define('_AM_SYSTEM_BLOCKS_SIDEFOOTERLEFT', 'Sidefod venstre');
define('_AM_SYSTEM_BLOCKS_SIDEFOOTERCENTER', 'Sidefod center');
define('_AM_SYSTEM_BLOCKS_SIDEFOOTERRIGHT', 'Sidefod højre');
...
define('_AM_SYSTEM_BLOCKS_CBFOOTERLEFT', 'Sidefodblok - venstre');
define('_AM_SYSTEM_BLOCKS_CBFOOTERCENTER', 'Sidefodblok - center');
define('_AM_SYSTEM_BLOCKS_CBFOOTERRIGHT', 'Sidefodblok - højre');
...
define('_AM_SYSTEM_BLOCKS_FOOTER_CENTER', 'Sidefod center');
define('_AM_SYSTEM_BLOCKS_FOOTER_RIGHT', 'Sidefod højre');

//2.7.1
//Comment-controls block error (used by modules/system/admin/blocks)
define('_AM_SYSTEM_BLOCKS_INVALID_CLONE', 'Ugyldige blokparametre.');

//2.7.1 backfilled translations
define('_AM_SYSTEM_BLOCKS_CUSTOMHTML', 'Brugerdefineret blok (HTML)');
define('_AM_SYSTEM_BLOCKS_CUSTOMSMILE', 'Brugerdefineret blok (automatisk format + smileys)');
define('_AM_SYSTEM_BLOCKS_AFWSMILE', 'Automatisk format (smileys aktiveret)');
define('_AM_SYSTEM_BLOCKS_PHP', 'PHP-script (filbaseret)');
define('_AM_SYSTEM_BLOCKS_AFNOSMILE', 'Automatisk format (smileys deaktiveret)');
define('_AM_SYSTEM_BLOCKS_CUSTOMNOSMILE', 'Brugerdefineret blok (automatisk format)');
define('_AM_SYSTEM_BLOCKS_CUSTOMPHP', 'Brugerdefineret blok (PHP)');

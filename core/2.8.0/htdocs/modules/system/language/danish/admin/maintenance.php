...
define('_AM_SYSTEM_MAINTENANCE_AVATAR', 'Fjern ubrugte bruger avatars');
...
define('_AM_SYSTEM_MAINTENANCE_TABLES_DESC', 'ANALYZE TABLE analyserer og gemmer data om tabellen. Mens analysen foregår låses tabellen for læsning.<br />
...
define('_AM_SYSTEM_MAINTENANCE_RESULT_AVATAR', 'Fjern ubrugted avatar handling');
...
//2.7.1 backfilled translations
define('_AM_SYSTEM_MAINTENANCE_CHOICE3', 'Reparer tabel(ler)');
define('_AM_SYSTEM_MAINTENANCE_CHOICE2', 'Tjek tabel(ler)');
define('_AM_SYSTEM_MAINTENANCE_CHOICE4', 'Analyser tabel(ler)');
define('_AM_SYSTEM_MAINTENANCE_DUMP_RECORDS', 'post(er)');
define('_AM_SYSTEM_MAINTENANCE_CHOICE1', 'Optimer tabel(ler)');

...
//2.8.0
define('_MI_SYSTEM_PREFERENCE_ACTIVE_LANGUAGES', 'Aktivér sprogadministration');
define('_MI_SYSTEM_PREFERENCE_ACTIVE_LANGUAGES_DESC', 'Administrer registret over sprogindstillinger, sprogpakker, statuskontroller og tilsidesættelser af sitets oversættelser.');
define('_MI_SYSTEM_BNAME14', 'Sprogvælger');

...
// define('MENUS_ACCOUNT_LOGIN', 'Log ind');
// define('MENUS_ACCOUNT_LOGOUT', 'Log ud');
// define('MENUS_ACCOUNT_REGISTER', 'Tilmeld');
// define('MENUS_ACCOUNT_MESSAGES', 'Beskeder');
// define('MENUS_ACCOUNT_NOTIFICATIONS', 'Notifikationer');
// define('MENUS_ACCOUNT_TOOLBAR', 'Værktøjslinje');

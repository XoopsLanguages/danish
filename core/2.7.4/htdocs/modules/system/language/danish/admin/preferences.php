...
define('_MD_AM_USERCOOKIEDSC', "Hvis cookienavnet er indstillet, vil 'Husk mig' være aktiveret for brugerlogin. Hvis en bruger har valgt 'Husk mig', bliver vedkommende automatisk logget ind. Udløbet for cookien er et år.");
...
define('_MD_AM_SESSSAMESITE_DSC', 'SameSite-attribut for sessionscookien. Brug kun "Ingen", når det er nødvendigt; det kræver Secure=true i moderne browsere.');
define('_MD_AM_SESSSECURE', 'Sessionscookie Sikker');
define('_MD_AM_SESSSECURE_DSC', 'Når den er aktiveret, sendes sessionscookien kun over HTTPS. Hvis SameSite=Ingen er valgt, vil dette blive tvunget til.');
...
define('_MD_AM_DEBUGMODE', 'Debug-tilstand');
...
define('_MD_AM_USESSLDSC', ' , SSL bruges til sikker login og kræver et certifikat. Kontakt din Host hvordan du kan få certifikat til dit websted.');
...
define('_MD_AM_BADEMAILSDSC', 'Adskil hver med en <strong>|</strong>, der ikke skelner mellem store og små bogstaver, regex aktiveret.');
define('_MD_AM_BADUNAMES', 'Indtaste navne, der ikke må vælges som brugernavn');
define('_MD_AM_BADUNAMESDSC', 'Adskil hver med en <strong>|</strong>, der ikke skelner mellem store og små bogstaver, regex aktiveret.');
...
define('_MD_AM_METARATING', 'Meta klassificering');
...
define('_MD_AM_METACOPYR', 'Meta ophavsret');
...
define('_MD_AM_CENSORWRDDSC', 'Indtast ord, der skal censureres i brugerindlæg.<br>Skill dem med en <strong>|</strong>, der ikke skelner mellem store og små bogstaver.');
...
define('_MD_AM_SOAP_WSDL', 'SÆBE - SÆBE WSDL');
...
define('_MD_AM_AUTH_CONFOPTION_LDAP', 'Standard LDAP bibliotek');
...
define('_MD_AM_LDAP_PROVIS_UPD', 'Vedligehold XOOPS kontoforsyning');
...
define('_MD_AM_CPANELDSC', 'Til administration');
define('_MD_AM_WELCOMETYPE', 'Afsendelse af velkomstmeddelelse');
define('_MD_AM_WELCOMETYPE_DESC', 'Metoden til at sende en velkomstbesked til en bruger efter deres vellykkede registrering.');
define('_MD_AM_WELCOMETYPE_EMAIL', 'E-mail');
define('_MD_AM_WELCOMETYPE_PM', 'Privat besked');
define('_MD_AM_WELCOMETYPE_BOTH', 'E-mail og privat besked');
define('_MD_AM_DEFAULT_NOTIFICATION_METHOD', 'Standard notifikationsmetode');
define('_MD_AM_DEFAULT_NOTIFICATION_METHOD_DESC', 'For nye brugere, når de abonnerer på meddelelser fra f.eks. et forum.');
define('_MD_AM_MODULEPREF', 'Modul Indstillinger');
define('_AM_SYSTEM_PREFERENCES_SETTINGS', 'System Indstillinger');
define('_MD_AM_SENDMAIL_NOT_FOUND', 'Sendmail binær ikke fundet. Tjek venligst din serverkonfiguration.');

//2.7.1 backfilled translations
define('_MD_AM_SMTPHOSTDESC', 'Enten et enkelt værtsnavn eller flere semikolon-adskilte værtsnavne.<br>Du kan også angive en anden port for hver vært ved at bruge dette format: [værtsnavn:port] (f.eks. "smtp1.example.com:25;smtp2.example.com").<br>Du kan også angive krypteringstype, for eksempel: (f.eks. "tls://smtp1.example.com:587;ssl://smtp2.example.com:465").<br>Værterne vil blive forsøgt i rækkefølge.');
define('_MD_AM_SESSEXPIREDSC', 'Maksimal varighed af sessionens inaktive tid i minutter (gælder kun, når \'brug brugerdefineret session\' er aktiveret).');
define('_MD_AM_SMTPHOST', 'SMTP-vært(er)');
define('_MD_AM_LDAP_MANAGER_DN_DESC', 'DN\'en for den bruger, der har tilladelse til at søge (f.eks. manager)');
define('_MD_AM_DEBUGMODE1', 'Aktivér fejlfinding (inline-tilstand)');
define('_MD_AM_LDAP_BASE_DN_DESC', 'Basis-DN\'en (Distinguished Name) for dit LDAP-katalogtræ.');
define('_MD_AM_LIGHT', 'Let (anbefales til multibyte-tegn)');
define('_MD_AM_METAKEYDSC', 'Meta-tagget keywords er en række nøgleord, der repræsenterer indholdet på dit websted. Skriv nøgleord adskilt af et komma eller et mellemrum. (F.eks. XOOPS, PHP, mySQL, portalsystem)');
define('_MD_AM_DEBUGMODE2', 'Aktivér fejlfinding (pop op-tilstand)');
define('_MD_AM_AVATARMAX', 'Maksimal filstørrelse på avatar (bytes)');
define('_MD_AM_SENDMAILPATHDESC', 'Sti til sendmail-programmet (eller en erstatning) på webserveren.');
define('_MD_AM_LDAP_LOGINNAME_ASDN_D', 'XOOPS-loginnavnet bruges i LDAP-DN\'en (f.eks.: uid=<loginname>,dc=xoops,dc=org)<br>Posten læses direkte på LDAP-serveren uden søgning');
define('_MD_AM_SESSNAMEDSC', 'Sessionens navn (gælder kun, når \'brug brugerdefineret session\' er aktiveret)');
define('_MD_AM_USERACTV', 'Kræver aktivering af brugeren (anbefales)');
define('_MD_AM_SENDMAIL_HELP_MISSING_BIN', 'Der blev ikke fundet nogen gyldig sendmail-kompatibel binær. Installer en MTA (f.eks. Postfix, msmtp), eller skift til SMTP i Indstillinger.');
define('_MD_AM_BADIPS', 'Indtast de IP-adresser, der skal udelukkes fra webstedet.<br>Adskil hver med et <strong>|</strong>, ikke versalfølsom, regulære udtryk aktiveret (så punktum - \'.\' betyder \'ethvert tegn\' og \'\\.\' betyder \'.\').');
define('_MD_AM_AVATARH', 'Maksimal højde på avatarbillede (pixel)');
define('_MD_AM_AVATARW', 'Maksimal bredde på avatarbillede (pixel)');
define('_MD_AM_STRICT', 'Streng (kun bogstaver og tal)');

//2.7.1 backfilled translations
define('_MD_AM_LDAP_USETLS_DESC', 'Brug en TLS-forbindelse (Transport Layer Security). TLS bruger standardportnummer 389<BR> og LDAP-versionen skal indstilles til 3.');
define('_MD_AM_LDAP_FILTER_PERSON_DESC', 'Særligt LDAP-filter til at finde brugeren. @@loginname@@ erstattes af brugerens loginnavn<br>SKAL VÆRE TOMT, HVIS DU IKKE VED, HVAD DU GØR!<br>Ex : (&(objectclass=person)(samaccountname=@@loginname@@)) til AD<br>Ex : (&(objectclass=inetOrgPerson)(uid=@@loginname@@)) til LDAP');

// 2.7.3
define('_MD_AM_ONLINETRACKING', 'Registrer hvem der er online?');
define('_MD_AM_ONLINETRACKINGDSC', 'Registrerer hver besøgende i online-tabellen, så blokken "Hvem er online" og online-listen kan vise antallet af medlemmer og gæster. Koster et par små forespørgsler pr. sidevisning. Slå dette fra, hvis du ikke har brug for disse tal - blokken vil så vise intet i stedet for forkerte tal.');

// 2.7.4
define('_MD_AM_TWOFACTORMODE', 'Totrinsgodkendelse');
define('_MD_AM_TWOFACTORMODEDSC', 'Fra sætter alle anden-faktor-udfordringer på pause, mens hvert medlems tilmelding bevares. Valgfri lader medlemmer tilmelde en authenticator-app eller e-mail-koder, og udfordrer medlemmer, der allerede har tilmeldt sig.');
define('_MD_AM_TWOFACTORMODE_OFF', 'Fra (sat på pause)');
define('_MD_AM_TWOFACTORMODE_OPTIONAL', 'Valgfri');

...
define('_AM_SYSTEM_MODULES_BTOMADMIN', 'Modul Administration');
...
define('_AM_SYSTEM_MODULES_ACCESS_USER_ADD', 'Tilføjet bruger rettighed til Gruppe-id: %s');
define('_AM_SYSTEM_MODULES_ACCESS_USER_ADD_ERROR', 'FEJL: Kunne ikke tilføje bruger rettighed til Gruppe-id: %s');
...
define('_AM_SYSTEM_MODULES_INSTALL_TESTDATA', 'Tilføj test data');
define('_AM_SYSTEM_MODULES_INSTALL_MORE', 'Installer flere moduler');
define('_AM_SYSTEM_MODULES_INSTALL_THISMODULE', 'Denne moduladmin');
define('_AM_SYSTEM_MODULES_FK_DISABLE', 'Kunne ikke deaktivere kontrol af fremmednøgle');
define('_AM_SYSTEM_MODULES_FK_ENABLE', 'Kunne ikke aktivere kontrol af fremmednøgle');
define('_AM_SYSTEM_MODULES_DROP_FAIL', 'Kunne ikke slette tabellen: %s');
define('_AM_SYSTEM_MODULES_DROP_OK', 'Tabt tabel: %s');

//2.7.1 backfilled translations
define('_AM_SYSTEM_MODULES_TIPS', '<ul>
<li>Hvis du installerer et nyt modul, så husk at konfigurere modulets indstillinger, blokke og brugerrettigheder!</li>
<li>For at skjule et modul i hovedmenublokken skal du sætte rækkefølgen til 0.</li>
<li>Slet ubrugte modulfiler fra din server for at undgå sikkerhedsproblemer og holde dit websted sikkert.</li>
<li>For at ændre modulernes rækkefølge (som afspejles i menuen) skal du blot trække og slippe modulerne til den ønskede placering.</li>
</ul>');
define('_AM_SYSTEM_MODULES_ORDER0', '(0 = skjul)');
define('_AM_SYSTEM_MODULES_ERRORSC', 'Fejl:');
define('_AM_SYSTEM_MODULES_LISTUPBLKS', 'Følgende blokke vil blive opdateret.<br>Vælg de blokke, hvis indhold (skabelon og indstillinger) må overskrives.<br>');
//2.7.1

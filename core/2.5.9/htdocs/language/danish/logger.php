 ...
 * @version         $Id: logger.php 12537 2014-05-19 14:19:33Z beckmi $
 */
...
define('_LOGGER_MEM_USAGE',"Hukommelsesbrug");
define('_LOGGER_MEM_ESTIMATED',"%s [Anslået]");
define('_LOGGER_NONE',"Ingen");
define('_LOGGER_ALL',"Alle");
define('_LOGGER_ERRORS',"Fejl");
define('_LOGGER_DEPRECATED',"Forældet");
define('_LOGGER_QUERIES',"Forespørgsler");
...
define('_LOGGER_CACHED',"Cachelagrede (regenererer hvert %s sekund)");
